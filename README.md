...
> 1.0使用Java开发，需要部署到VPS上，功能相对简单，需要配置Java环境
>
> 2.0使用Python开发，可以部署到CDN上，或者PHP站点，核心功能全部可定制
...
具体请点击下方的**手册**查看帮助和介绍，如果遇到问题可以在下方评论区留言，我看到后会第一时间回复答疑

无特殊需求建议使用最新的2.5版本

## 已知问题

在使用IIS HTTP 服务器时，如果文件名包含+号，可能会无法访问，请尽量避免此情况
